...
public class ImageLoaderOptions {
	...
	public static DisplayImageOptions getAvatorOption() {
		if (mAvatorOption == null) {
			mAvatorOption = new DisplayImageOptions.Builder()
					.showImageOnFail(R.mipmap.user_defult_icon)
					.showImageOnLoading(R.mipmap.user_defult_icon)
					.showImageForEmptyUri(R.mipmap.user_defult_icon)
	...
	public static DisplayImageOptions getDefaultAvatorOption(int rounded) {
		DisplayImageOptions defaultAvatorOption = NoMemOptionCache.get(R.mipmap.user_defult_icon+""+R.mipmap.user_defult_icon+""+R.mipmap.user_defult_icon+""+rounded);
		if (defaultAvatorOption == null) {
			defaultAvatorOption = new DisplayImageOptions.Builder()
					...
					.cacheInMemory(true).cacheOnDisk(true).build();
			NoMemOptionCache.put(R.mipmap.user_defult_icon+""+R.mipmap.user_defult_icon+""+R.mipmap.user_defult_icon+""+rounded,defaultAvatorOption);
		}
